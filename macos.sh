...
#sudo scutil --set ComputerName "munmakki"
#sudo scutil --set HostName "munhost"
#sudo scutil --set LocalHostName "munlocalhost"
...
# Mouse: Disable mouse acceleration (to enable, set value to 0,1 or 2
