...
git clone https://github.com/scrooloose/nerdtree.git ~/.vim/pack/trinne/start/nerdtree
vim -u NONE -c "helptags ~/.vim/pack/trinne/start/nerdtree/doc" -c q

# https://vimawesome.com/plugin/surround-vim
git clone https://github.com/tpope/vim-surround.git ~/.vim/pack/trinne/start/vim-surround
vim -u NONE -c "helptags ~/.vim/pack/trinne/start/vim-surround/doc" -c q

# https://vimawesome.com/plugin/vim-fireplace
git clone https://github.com/tpope/vim-fireplace.git ~/.vim/pack/trinne/start/vim-fireplace
vim -u NONE -c "helptags ~/.vim/pack/trinne/start/vim-fireplace/doc" -c q

# https://vimawesome.com/plugin/vim-clojure-static
git clone https://github.com/guns/vim-clojure-static.git ~/.vim/pack/trinne/start/vim-clojure-static
vim -u NONE -c "helptags ~/.vim/pack/trinne/start/vim-clojure-static/doc" -c q

# https://vimawesome.com/plugin/vim-salve
git clone https://github.com/tpope/vim-salve.git ~/.vim/pack/trinne/start/vim-salve
git clone https://github.com/tpope/vim-projectionist.git ~/.vim/pack/trinne/start/vim-projectionist
git clone https://github.com/tpope/vim-dispatch.git ~/.vim/pack/trinne/start/vim-dispatch
git clone https://github.com/tpope/vim-fireplace.git ~/.vim/pack/trinne/start/vim-fireplace
...
git clone https://github.com/vim-airline/vim-airline-themes.git ~/.vim/pack/trinne/start/vim-airline-themes

# https://vimawesome.com/plugin/indentline
git clone https://github.com/yggdroot/indentline.git ~/.vim/pack/trinne/start/indentline
vim -u NONE -c "helptags ~/.vim/pack/trinne/start/indentline/doc" -c q

# https://vimawesome.com/plugin/rainbow-parentheses-vim
git clone https://github.com/kien/rainbow_parentheses.vim.git ~/.vim/pack/trinne/start/rainbow_parentheses.vim
